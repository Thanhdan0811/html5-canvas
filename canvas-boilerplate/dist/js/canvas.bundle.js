...
var gravity = 1;
var friction = 0.85; // Event Listeners
  ...
  _createClass(Ball, [{
    ...
    value: function update() {
      if (this.y + this.radius + this.dy >= canvas.height) {
        this.dy = -this.dy * friction; // this.dy = -this.dy;
      } else {
      ...
      if (this.x + this.radius + this.dx > canvas.width || this.x - this.radius < 0) {
        this.dx = -this.dx;
      } else if (canvas.height - this.y - this.radius <= 1) {// this.dx -= this.dx * 0.021;
      }

      this.x += this.dx; // console.log(this.y + this.radius, canvas.height);
...
function init() {
  ...
  for (var i = 0; i < 800; i++) {
    ...
    var radius = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(20, 50);
    var x = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(radius, canvas.width - radius);
    var y = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(0, canvas.height / 2 - radius);
